...
def parse_args():
    ...
    # general
    parser.add_argument('--data_path', default='/home/ubuntu/', type=str, help='training and test data path')
    ...
    parser.add_argument('--test_model', default='50', type=str, help='which one to test') 
...
def test_net():
    ...
    data_loaders = get_loader(config, mode="test")    # return train&test
    #get the solver
